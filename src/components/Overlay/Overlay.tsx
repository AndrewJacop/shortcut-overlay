...
const Overlay: FC = () => {
  ...
  if (!sheet) {
    return (
      <div
        className="relative flex h-screen w-screen flex-col rounded-xl backdrop-blur-md overflow-hidden animate-pulse"
        style={{ backgroundColor: `rgba(var(--overlay-bg-rgb), ${overlayOpacity})` }}
      >
        {/* Skeleton header */}
  ...
  return (
    <div
      className="relative flex h-screen w-screen flex-col rounded-xl backdrop-blur-md text-zinc-900 dark:text-white shadow-2xl overflow-hidden"
      style={{ backgroundColor: `rgba(var(--overlay-bg-rgb), ${overlayOpacity})` }}
    >
      {/* Header */}
